...
if (isset($_POST['saveData'])) {
    ...
    if (isset($_POST['updateRecordID'])) {
        ...
        if ($update) {
            ...
            echo '<script language="Javascript">parent.$(\'#mainContent\').simbioAJAX(parent.getPreviousAJAXurl(), \'post\');</script>';
        ...
        if ($insert) {
            ...
            echo '<script language="Javascript">parent.$(\'#mainContent\').simbioAJAX(\''.$_SERVER['PHP_SELF'].'\', \'post\');</script>';
    ...
    if ($error_num == 0) {
        ...
        echo '<script language="Javascript">parent.$(\'#mainContent\').simbioAJAX(\''.$_SERVER['PHP_SELF'].'?'.$_POST['lastQueryStr'].'\');</script>';
    } else {
