...
<div class="menuBoxInner biblioIcon">
    <?php echo strtoupper(__('Bibliographic')); ?> - <a href="<?php echo MODULES_WEB_ROOT_DIR; ?>bibliography/index.php?action=detail" class="ajaxLink"><?php echo __('Add New Bibliography'); ?></a>
    &nbsp; <a href="<?php echo MODULES_WEB_ROOT_DIR; ?>bibliography/index.php" class="ajaxLink"><?php echo __('Bibliographic List'); ?></a>
    <hr />
    <form name="search" id="ajaxSearchForm" action="<?php echo MODULES_WEB_ROOT_DIR; ?>bibliography/index.php" method="get" style="display: inline;"><?php echo __('Search'); ?> :
